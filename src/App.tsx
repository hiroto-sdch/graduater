      ...
      <header className='App-header'>
        <div>
          ...
          <div>
            ...
            <a href={`https://twitter.com/intent/tweet?url=https://graduation-checker-itf.netlify.app%0a%0a&text=今までに${RecommendedExam[1]}単位を習得しました！%0aあなたも単位を確認しませんか？%0a&hashtags=卒単チェッカーforITF`} target='blank'>Twitterに共有する</a>
            </Button>
          </div>}
        </div>
      </header>
